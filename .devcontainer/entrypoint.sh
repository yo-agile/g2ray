...
echo ""
echo "1) vless://${UUID}@94.130.50.12:443?encryption=none&security=tls&type=grpc&serviceName=tunnel&mode=multi&sni=${SNI}#@Kakoolnews-DE"
echo ""
echo "2) vless://${UUID}@63.141.252.203:443?encryption=none&security=tls&type=grpc&serviceName=tunnel&mode=multi&sni=${SNI}#@Kakoolnews-US1"
echo ""
echo "3) vless://${UUID}@50.7.5.83:443?encryption=none&security=tls&type=grpc&serviceName=tunnel&mode=multi&sni=${SNI}#@Kakoolnews-US2"
echo ""
echo "========================================"
echo ""
